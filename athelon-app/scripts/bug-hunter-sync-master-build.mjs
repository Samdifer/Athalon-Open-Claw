...
function parseArgs(argv) {
  const opts = {
    reportPath: "",
    masterPath: "MASTER-BUILD-LIST.md",
    dryRun: false,
    force: false,
  };
...
function printHelp() {
  process.stdout.write(
    [
      "Usage:",
      "  node scripts/bug-hunter-sync-master-build.mjs --report <path> [--master MASTER-BUILD-LIST.md] [--dry-run] [--force]",
      "",
      "Behavior:",
