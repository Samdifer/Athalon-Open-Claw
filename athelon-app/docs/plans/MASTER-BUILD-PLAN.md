...
This file is a derived planning reference generated from the canonical feature spec at `MASTER-BUILD-LIST.md`.

Canonical source of truth: `athelon-app/MASTER-BUILD-LIST.md`

## Canonical Ownership

1. Do not directly author feature status in this file.
2. Update canonical feature records in `MASTER-BUILD-LIST.md` (Registry A/Registry B) or through Bug Hunter sync.
...
1. Update canonical registries in `MASTER-BUILD-LIST.md` (or run Bug Hunter sync).
