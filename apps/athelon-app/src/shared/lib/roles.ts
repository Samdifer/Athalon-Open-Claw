...
export const MRO_ROLES = {
  ...
  lead_technician: { label: "Lead Technician", description: "Execute work, sign off steps, manage work cards", level: 50 },
...
export const ROLE_NAV_ACCESS: Record<MRORole, NavSection[]> = {
  admin: [
    ...
    "billing", "compliance", "findings", "personnel", "my-work",
  ...
  qcm_inspector: [
    "dashboard", "work-orders", "compliance", "fleet", "findings",
  ],
  billing_manager: [
    "dashboard", "billing", "customers", "reports",
  ],
  lead_technician: [
    "dashboard", "my-work", "work-orders", "parts", "findings",
  ],
  technician: [
    "dashboard", "my-work", "work-orders", "parts", "findings",
  ],
