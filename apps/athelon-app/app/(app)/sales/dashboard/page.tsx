  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid gap-3 grid-cols-1 md:grid-cols-2 xl:grid-cols-5">
        ...
        <Card><CardHeader className="pb-2"><CardTitle className="text-xs text-muted-foreground flex items-center gap-1"><Gauge className="h-3.5 w-3.5" />LTV:CAC</CardTitle></CardHeader><CardContent><p className="text-2xl font-semibold">{actualCAC > 0 ? `${fmtNum(ltvCac, 2)}:1` : "N/A"}</p>{actualCAC === 0 && <p className="text-xs text-muted-foreground mt-1">CAC is $0 — ratio not computable</p>}</CardContent></Card>
