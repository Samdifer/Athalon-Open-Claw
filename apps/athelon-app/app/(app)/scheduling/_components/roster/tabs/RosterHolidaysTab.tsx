...
import type { RosterHolidayRow } from "../types";
...
interface RosterHolidaysTabProps {
...
export function RosterHolidaysTab({
  holidays,
  canManage,
  organizationId,
  shopLocationId,
}: RosterHolidaysTabProps) {
  // --- Add holiday form ---
  ...
  const groupedByYear = useMemo(() => {
    ...
    const groups = new Map<string, RosterHolidayRow[]>();
  ...
  function beginEdit(holiday: RosterHolidayRow) {
    setEditingId(holiday._id);
    setEditName(holiday.name);
    setEditDateKey(holiday.dateKey);
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex gap-2 justify-end">
                          ...
                          <Button
                            ...
                            disabled={!editName.trim() || !editDateKey.trim()}
                          >
                            ...
                            <>
                              <div className="flex items-center gap-1.5">
                                <Switch
                                  ...
                                  onCheckedChange={() => handleToggleObserved(holiday._id)}
                                />
