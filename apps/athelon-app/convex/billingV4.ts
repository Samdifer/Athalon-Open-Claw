...
export const createCustomer = mutation({
  args: {
    ...
    homeAirportFaaLocId: v.optional(v.string()),
    homeAirportIcao: v.optional(v.string()),
    homeAirportName: v.optional(v.string()),
    homeAirportCity: v.optional(v.string()),
  ...
  handler: async (ctx, args) => {
    ...
    const customerId = await ctx.db.insert("customers", {
      ...
      homeAirportFaaLocId: args.homeAirportFaaLocId?.trim() || undefined,
      homeAirportIcao: args.homeAirportIcao?.trim() || undefined,
      homeAirportName: args.homeAirportName?.trim() || undefined,
      homeAirportCity: args.homeAirportCity?.trim() || undefined,
      part145CertNo: args.part145CertNo?.trim() || undefined,
