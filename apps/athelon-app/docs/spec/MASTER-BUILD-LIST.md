...
| FS-0070 | 70 | Unaccounted Maintenance Findings Lifecycle | not_implemented | doc_reviewed | 2026-03-08T00:00:00Z | null | opus-c | Track AD/SB/predicted/carry-forward/external findings through triage→deferral→scheduling→resolution lifecycle with FAR-aware controls, RTS integration, and KPI observability. | Spec package created; no code implementation yet. Data model, state machine, edge-case rules, and phased rollout defined. | knowledge/plans/maintenance-findings-unaccounted-spec.md; knowledge/plans/maintenance-findings-rollout.md | Feature #70; FS-0070; MBP-0154,MBP-0155,MBP-0156,MBP-0157,MBP-0158 | Build from spec; integrates with existing adCompliance, maintenancePredictions, carryForwardItems, returnToService, and complianceLedgerEvents. | Not Implemented |

## Registry B — Atomic Features (158)
...
| MBP-0154 | FS-0070 | GRP-005 | maintenanceFindings data model + triage mutations | maintenanceFindings and maintenanceFindingEvents tables, createFinding/triageFinding/resolveFinding mutations, state machine guards. | OPUS-C | MF-P1 | knowledge/plans/maintenance-findings-unaccounted-spec.md | P0 | Wave5 | compliance | ["GRP-001", "GRP-002"] | All missing behaviors are completed and verified end-to-end against source requirement text. | npx tsc --noEmit --skipLibCheck; state machine transition validation. | missing | not_implemented | doc_reviewed | 2026-03-08T00:00:00Z | null | opus-c | knowledge/plans/maintenance-findings-unaccounted-spec.md#MF-P1 | MBP-0154; MF-P1 | opus-c spec package; Phase 1 data foundation. |
| MBP-0155 | FS-0070 | GRP-005 | Findings triage UI (list + detail pages) | /compliance/findings list page with filters; /compliance/findings/[id] detail with timeline. | OPUS-C | MF-P1-UI | knowledge/plans/maintenance-findings-rollout.md | P0 | Wave5 | compliance | ["GRP-002", "GRP-003"] | All missing behaviors are completed and verified end-to-end against source requirement text. | npx tsc --noEmit --skipLibCheck; targeted Playwright scenario. | missing | not_implemented | unreviewed | 2026-03-08T00:00:00Z | null | opus-c | knowledge/plans/maintenance-findings-rollout.md#MF-P1-UI | MBP-0155; MF-P1-UI | opus-c spec package; Phase 1 UI. |
| MBP-0156 | FS-0070 | GRP-005 | Prediction/carry-forward/AD auto-creation + RTS integration | Auto-create findings from predictions/carry-forwards; overdue finding RTS block; deferral expiry automation. | OPUS-C | MF-P2 | knowledge/plans/maintenance-findings-rollout.md | P0 | Wave5 | compliance | ["GRP-001", "GRP-002"] | All missing behaviors are completed and verified end-to-end against source requirement text. | npx tsc --noEmit --skipLibCheck; integration scenario validation. | missing | not_implemented | unreviewed | 2026-03-08T00:00:00Z | null | opus-c | knowledge/plans/maintenance-findings-rollout.md#MF-P2 | MBP-0156; MF-P2 | opus-c spec package; Phase 2 integration. |
| MBP-0157 | FS-0070 | GRP-009 | Findings KPI dashboard + observability | /compliance/findings/dashboard with aging charts, conversion rates, SLA compliance, closure cycle time. | OPUS-C | MF-P3 | knowledge/plans/maintenance-findings-rollout.md | P1 | Wave5 | product | ["GRP-002", "GRP-003"] | All missing behaviors are completed and verified end-to-end against source requirement text. | npx tsc --noEmit --skipLibCheck; dashboard render + data accuracy. | missing | not_implemented | unreviewed | 2026-03-08T00:00:00Z | null | opus-c | knowledge/plans/maintenance-findings-rollout.md#MF-P3 | MBP-0157; MF-P3 | opus-c spec package; Phase 3 dashboarding. |
| MBP-0158 | FS-0070 | GRP-005 | Findings audit readiness + CSV export | Integrate findings backlog into audit readiness score; findings CSV export; pre-audit checklist inclusion. | OPUS-C | MF-P3-AUD | knowledge/plans/maintenance-findings-rollout.md | P1 | Wave5 | compliance | ["GRP-001", "GRP-003"] | All missing behaviors are completed and verified end-to-end against source requirement text. | npx tsc --noEmit --skipLibCheck; audit readiness score validation. | missing | not_implemented | unreviewed | 2026-03-08T00:00:00Z | null | opus-c | knowledge/plans/maintenance-findings-rollout.md#MF-P3-AUD | MBP-0158; MF-P3-AUD | opus-c spec package; Phase 3 audit integration. |
